...
document.addEventListener("DOMContentLoaded", () => {
    const countdown = document.getElementById("tg26Countdown");

    if (!countdown) return;

    const days = countdown.querySelector('[data-unit="days"]');
    ...
    const target = new Date("2026-10-03T14:00:00+02:00").getTime();
